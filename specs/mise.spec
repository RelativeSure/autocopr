...
begins cooking, they should have all their utensils and ingredients ready
...
AWS_ACCESS_KEY_ID that may differ between projects. It can also be used
to automatically activate a Python virtualenv when entering projects too.
...
# Man page
install -pvD -m 0644 man/man1/%{name}.1.gz %{buildroot}%{_mandir}/man1/%{name}.1.gz
