...
%build
zig build install     --summary all     --prefix "%{_prefix}"     -Dprefix-exe-dir=%{_bindir}     -Dversion-string=%{version}-%{release}     -Doptimize=ReleaseFast     -Dcpu=baseline     -Dpie=true     -Demit-docs
