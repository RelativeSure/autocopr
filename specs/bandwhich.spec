...
install -pvD -m 0644 assets/%{name}.bash %{buildroot}%{bash_completions_dir}/%{name}
install -pvD -m 0644 assets/_%{name} %{buildroot}%{zsh_completions_dir}/_%{name}
install -pvD -m 0644 assets/%{name}.fish %{buildroot}%{fish_completions_dir}/%{name}.fish
install -pvD -m 0644 assets/%{name}.1 %{buildroot}%{_mandir}/man1/%{name}.1
